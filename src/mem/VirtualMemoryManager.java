...
public class VirtualMemoryManager {
    ...
    public int allocateGlobalVariable(String name, String type) {
        ...
        switch (type) {
            case "int":
                addr = GLOBAL_INT_BASE + nextGlobalInt++;
                break;
            case "float":
    ...
    public int allocateLocalVariable(String funcName, String name, String type) {
        ...
        switch (type) {
            case "int":
                addr = LOCAL_INT_BASE + nextLocalInt++;
                break;
            case "float":
    ...
    public int getConstantAddress(String literal, String type) {
        ...
        switch (type) {
            case "int":
                addr = CONST_INT_BASE + nextConstInt++;
                break;
            case "float":
                addr = CONST_FLOAT_BASE + nextConstFloat++;
                break;
            case "string":
                addr = CONST_STRING_BASE + nextConstString++;
                break;
            default:
                throw new RuntimeException("Tipo desconocido: " + type);
        }
    ...
    public int newTemporal(String type) {
        ...
        switch (type) {
            case "int":
                addr = TEMP_INT_BASE + nextTempInt++;
                break;
            case "float":
